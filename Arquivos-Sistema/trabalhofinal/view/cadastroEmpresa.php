...
<head>
  ...
  <!-- parte do ajax que fica no servidor-->
  <script rsc="text/javascript">
    $(function() {
        $("#meuform").submit(function(event){
            ...
            $.ajax({
                type:"post",
                url:"../Controller/insereEmpresa.php",
                data:dados_form,
  ...
  <form class="form-horizontal" id="meuform" method="post"><br>
    <fieldset>
        <div class="panel panel-primary">
          <div class="panel-heading" id="alinhamentoCentro">Cadastro de Empresa</div>
             <div class="panel-body">
                ...
                <!-- Text input-->
              <div class="form-group">
                  <label class="col-md-2 control-label" for="Nome">CNPJ *</label>  
                    <div class="col-md-2">
                        <input type="text" maxlength="18" class="form-control input-md"  id="cnpj" name="cnpj" required="" pattern="[0-9]{2}[.]{1}[0-9]{3}[.]{1}[0-9]{3}[/]{1}[0-9]{4}[-]{1}[0-9]{2}"
                         title="CNPJ invalido" placeholder=" 00.000.000/0000-00" OnKeyPress="formatar('##.###.###/####-##', this)"/>
                    </div>
                  <label class="col-md-1 control-label" for="Nome">Setor<h11>*</h11></label>  
                  <div class="col-md-2">
                      <input type="text" class="form-control"  name="setor" id="setor" required=''><br />
                  </div>
              </div>
